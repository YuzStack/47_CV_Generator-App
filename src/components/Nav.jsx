...
function Nav({ onDownload }) {
  return (
    <nav className='sticky top-0 z-10 flex items-center justify-between bg-white px-3.5 py-2.5 sm:px-5 sm:py-4'>
      ...
      <Button
        onClick={onDownload}
        className='flex cursor-pointer gap-1.5 rounded-sm border border-[#E6E7EB] p-1.5 text-xs font-medium text-black duration-150 hover:bg-[#F3F4F6] sm:rounded-sm sm:px-3 sm:py-2'
      >
        <span>
          <Download size={16} />
        </span>
